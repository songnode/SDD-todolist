...
> 이번 시간에는 GitHub Spec Kit 도구의 명령어 체계를 학습합니다. 
...
9. [요구사항이 바뀔 때 대처법](#9-요구사항이-바뀔-때-대처법)
10. [팀 협업 시 활용 팁](#10-팀-협업-시-활용-팁)
11. [자주 묻는 질문 FAQ](#11-자주-묻는-질문-faq)
12. [핵심 정리 및 명령어 요약](#12-핵심-정리-및-명령어-요약)
...
**Speckit Install**
Windows PowerShell 에서 Install 합니다.
